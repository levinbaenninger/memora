...
const changeEmailLocalization = {
  CONFIRM_YOUR_NEW_EMAIL: "Confirm your new email address",
  LOGO: "Logo",
  CLICK_BUTTON_TO_CONFIRM_EMAIL:
    "Click the button below to confirm your new email address {newEmail} for your {appName} account.",
...
export interface ChangeEmailProps {
   ...
   * @remarks `ChangeEmailLocalization`
   */
  localization?: Partial<ChangeEmailLocalization>
}
...
export const ChangeEmail = ({
  ...
  const localization = {
    ...ChangeEmail.localization,
    ...props.localization
  }

  const previewText = localization.CONFIRM_YOUR_NEW_EMAIL
        ...
        <Body className={cn("bg-background font-sans", classNames?.body)}>
          ...
          >
            ...
            >
              ...
              >
                {localization.CONFIRM_YOUR_NEW_EMAIL}
              </Heading>

              <Text className={cn("text-sm font-normal", classNames?.content)}>
                {(() => {
                  const textWithAppName =
                    localization.CLICK_BUTTON_TO_CONFIRM_EMAIL.replace(
                      "{appName}",
                      appName || ""
                    )
                      .replace(/\s{2,}/g, " ")
...
ChangeEmail.localization = changeEmailLocalization

ChangeEmail.PreviewProps = {
  url: "https://better-auth-ui.com/auth/change-email?token=example-token",
